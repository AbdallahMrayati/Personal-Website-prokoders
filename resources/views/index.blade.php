                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">Development &middot; </div>
                        </div>
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            ...
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ route('allprojects') }}">Projects</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="{{ asset('user/assets/abd-1.png') }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is Abdullah Mrayati and I can help your business to
                            Get online and grow fast.</p>
                        <p class="text-muted">Backend Laravel. Skilled in utilizing the Laravel framework to build
                            scalable and efficient backend
                            systems, with a focus on creating robust and reliable software.</p>
